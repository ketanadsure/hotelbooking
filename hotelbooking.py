class Hotel:
    ...
    def __init__(self ,s=0,p=0,r=0,t=0,a=1800, rt='',name='',address='',cindate='',coutdate=''):

        print ("\n\n*****WELCOME TO ROYAl PALM HOTEL*****\n")
    ...
    def roomrent(self):
        ...
        print ("1.  AC Room---->rs 6000 PN\-")

        print ("2.  Non AC Room---->rs 5000 PN\-")
        ...
        if(x==1):
            ...
            print ("you have opted room type AC")

            self.s=self.s+6000*n

        elif (x==2):

            print ("you have opted room type Non AC")

            self.s=self.s+5000*n
    ...
    def restaurentbill(self):
        ...
        print("1.water----->Rs20",    "2.tea----->Rs10",  "3.breakfast combo--->Rs90",   "4.lunch---->Rs150",  "5.dinner--->Rs150",  "6.Exit")
